  ...
  candidates: [
    {
      ...
      operational_monitoring_requirements: {
        ...
        nighttime_power: { required: false, rule: '47 CFR §73.99', nighttime_tpo_limit_kw: 0.5, note: 'Class D secondary on clear channel 780 kHz: nighttime power limited to 0.5 kW max; DA-N pattern or prohibition may apply per §73.182 NIF conditions. Check specific license conditions.' },
