...
const server = app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`[genoa-api] db_configured=${poolReady()} measurement_sidecar=${!!process.env.MEASUREMENT_SIDECAR_URL} identity_sidecar=${!!process.env.IDENTITY_SIDECAR_URL}`);
});
