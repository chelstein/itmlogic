...
export function exportTxt(exhibit){
  ...
  if (pop.source){
    ...
    L.push(`** MODEL ESTIMATE — population sourced from area/density proxy, not Census/ACS data. **`);
  ...
  L.push('-- ENGINEERING CERTIFICATION (ENGINEER STAMP REQUIRED BEFORE FILING) --');
